...
def get_symbol(num_class,**kwargs):
    ...
    units=[2, 2, 2, 2]
    return resnext(units=units, num_stage=4, filter_list=[64, 64, 128, 256, 512], ratio_list=ratio_list, num_class=num_class, num_group=64,
                   data_type="imagenet", drop_out=0.0, bottle_neck = False)
