...
'''
import mxnet as mx
from tools.dorefa_ops import get_dorefa
BITW = 1
BITA = 1
...
def residual_unit(data, num_filter, stride, dim_match, name, bottle_neck=True, bn_mom=0.9, workspace=256, memonger=False):
    ...
    if bottle_neck:
        ...
        act1 = mx.sym.QActivation(data=bn1, name=name + '_relu1',act_bit=BITA)
        ...
        act2 = mx.sym.QActivation(data=bn2, name=name + '_relu2',act_bit=BITA)
        ...
        act3 = mx.sym.QActivation(data=bn3, name=name + '_relu3',act_bit=BITA)
    ...
    def visualize_stream(self, im_list, root_dir=None, extension=None,
        ...
        for idx, im in enumerate(im_list):
            ...
            for k, det in enumerate(dets):
                ...
                plt.savefig("camvid_mxnet/"+str(idx)+".png",bbox_inches='tight',pad_inches=0)
                #plt.axis('on')
                #plt.draw()
