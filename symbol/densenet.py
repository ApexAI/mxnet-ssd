...
def DenseNet(units, num_stage, growth_rate, num_class, data_type="imagenet", reduction=0.5, drop_out=0., bottle_neck=True,
    ...
    if data_type == 'imagenet':
        ...
        print("else########################")
        body = mx.sym.Convolution(data=data, num_filter=growth_rate * 2, kernel=(3, 3), stride=(1, 1),
                                  no_bias=True, name="conv0", workspace=workspace)
